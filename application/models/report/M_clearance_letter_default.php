...
class M_clearance_letter_default extends CI_Model
{
	...
	public function Index($id){
		...
		if( $id > 0 ){
			...
			$pdfPath = 'temp_files_pdf/Clearance_test'.$id.'_.pdf';
			...
			$pdfPath = 'temp_files_pdf/Clearance_default_test'.$clinic->ID.'_.pdf';
			$pdf->Output('F', $pdfPath);
			echo base_url($pdfPath);
		}
