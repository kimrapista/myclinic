...
class M_appointments extends CI_Model
{
	...
	public function Index()
	{
		...
		$sql = $this->db->query("SELECT MR.ID, MR.PATIENTID, P.FIRSTNAME, P.MIDDLENAME, P.LASTNAME, P.SEX, 
			MR.CHECKUPDATE, MR.AGE, MR.CHEIFCOMPLAINT, MR.FINDINGS, MR.DIAGNOSIS, MR.BRANCH, MR.APPOINTMENT,MR.APPOINTMENTDATE,MR.APPOINTMENTDESCRIPTION, 
			U.NAME AS CREATEDNAME, S.NAME AS SUBCLINICNAME, C.CLINICNAME
			...
			LEFT JOIN subclinic S ON S.ID = MR.APPOINTMENTSUBCLINICID
