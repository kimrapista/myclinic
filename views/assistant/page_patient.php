...
<section ng-controller="PagePatient" >
	...
	<div class="container-xl">
		...
		<md-button ng-show="opt.isLoaded && opt.AUTHORIZATION" href="{{opt.newMRUrl}}" class="md-fab md-primary md-fab-bottom-right fixed" >
										...
										<div layout="column">
											<md-menu >
												...
												<md-menu-content>
													...
													<md-menu-item ng-if="opt.AUTHORIZATION">
