...
<head>
	...
	<script>
		var startUp = {
			...
			AUTHORIZATION : '<?php echo $this->session->AUTHORIZATION; ?>',
			EDITMR : '<?php echo $this->session->EDITMR; ?>'
		}
	</script>
</head>
...
<body ng-cloak>
	...
	<div ng-controller="Navigation" class="mdl-layout mdl-js-layout {{opt.drawer ? 'mdl-layout--fixed-drawer' : ''}} mdl-layout--fixed-header"  >
		...
		<md-sidenav class="md-sidenav-right md-whiteframe-2dp md-sidebar-md" md-component-id="advisory-sb">
			...
			<md-content>
				...
				<div class="px-3">
					<md-switch ng-model="opt.drawer" ng-click="Toggle_Drawer();" aria-label="Drawer" class="md-primary">
						Fixed Menu Panel 
					</md-switch>
				</div>
	...
	<script src="<?php echo base_url('views/assistant/js/app.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/global.js').$_SESSION['ver']; ?>"></script>


	<script src="<?php echo base_url('views/assistant/js/pageDashboard.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/pagePatients.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/formPatient.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/pagePatient.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/formMedical.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/pageMedical.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/pageAppointment.js').$_SESSION['ver']; ?>"></script>
 	
	<script src="<?php echo base_url('views/assistant/js/pageServices.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/formService.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/pageDiscounts.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/formDiscount.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/pageHmo.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/formHmo.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/pagePrescriptions.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/formPrescription.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/pageInstructions.js').$_SESSION['ver']; ?>"></script>
	<script src="<?php echo base_url('views/assistant/js/formInstruction.js').$_SESSION['ver']; ?>"></script>
