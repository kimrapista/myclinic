...
app.controller('PageSpecialist', function($scope, $http, $timeout, $filter, $rootScope, global){ 


	$rootScope.$emit("Title_Global", { TITLE : 'SPECIALIST', BACKURL:'' });

	$scope.opt = {
		isLoaded : false,
		isSearch : false,
		searchText : '',
		searchUrl : global.baseUrl + 'settings/specialist/index',
		newUrl : '#!/settings/specialist/new',
		editUrl :  '#!/settings/specialist/'
	}
