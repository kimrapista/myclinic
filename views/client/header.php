...
<body ng-cloak>
	...
	<div ng-controller="Navigation" ng-init="Init();" class="mdl-layout mdl-js-layout {{Page.drawer ? 'mdl-layout--fixed-drawer' : ''}} mdl-layout--fixed-header"  >
							...
							<md-menu md-position-mode="right bottom">
								<md-button ng-click="$mdMenu.open($event);" class="md-mini">
									<div layout="row">
										...
										<span ng-bind="Notify().APPOINTMENTS.length"></span>
									</div>										
								</md-button>
		...
		<div class="mdl-layout__drawer signed" >
			<div class="menus-wrapper scroll"> 
				...
				<nav ng-if="!Me().SETUP_CLINIC_ROMERO" class="mdl-navigation">
					<a href="#!/dashboard" ng-show="Me().isAdmin" class="mdl-navigation__link" >Dashboard</a>
					...
					<div class="subgroup" >
						...
						<a href="#!/settings/lab-template" ng-show="Me().isAdmin" class="mdl-navigation__link" >Lab Template</a>
						<a href="#!/settings/lab-monitoring" ng-show="Me().isAdmin" class="mdl-navigation__link" >Lab Monitoring</a>
						<a href="#!/settings/procedures" ng-show="Me().isAdmin" class="mdl-navigation__link" >Procedures</a>
					</div>
				</nav>
	...
	<script src="<?php echo base_url('views/client/_js/labMonitoring.js').$version; ?>"></script>
	<script src="<?php echo base_url('views/client/_services/labMonitoring.services.js').$version; ?>"></script>

	<script src="<?php echo base_url('views/client/_js/procedures.js').$version; ?>"></script>
	<script src="<?php echo base_url('views/client/_services/procedures.services.js').$version; ?>"></script>
