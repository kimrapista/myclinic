...
app.factory('ServicesServices',function ($http, $q, $filter, $timeout, $interval, global) {

	var url = global.baseUrl + 'settings/services/index';
	var urlForm = global.baseUrl + 'settings/services/form-data/';
	...
	function Format(detail){
		...
		if ( typeof detail.AUTOADD != 'boolean' )
			detail.AUTOADD = detail.AUTOADD == 'Y' ? true : false;
