...
app.factory('LaboratoryServices',function ($http, $q, $filter, $timeout, $interval, global) {

	var url = global.baseUrl + 'settings/laboratory/index';
	var urlForm = global.baseUrl + 'settings/laboratory/form-data/';
