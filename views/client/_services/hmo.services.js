...
app.factory('HMOServices',function ($http, $q, $filter, $timeout, $interval, global) {

	var url = global.baseUrl + 'settings/hmo/index';
	var urlForm = global.baseUrl + 'settings/hmo/form-data/';
