...
app.factory('InstructionsServices',function ($http, $q, $filter, $timeout, $interval, global) {

	var url = global.baseUrl + 'settings/instructions/index';
	var urlForm = global.baseUrl + 'settings/instructions/form-data/';
	...
	function Format(detail){
		...
		if ( typeof detail.ACTIVE != 'boolean' )
			detail.ACTIVE = detail.ACTIVE == 'Y' ? true : false;
