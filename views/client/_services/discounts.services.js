...
app.factory('DiscountsServices',function ($http, $q, $filter, $timeout, $interval, global) {

	var url = global.baseUrl + 'settings/discounts/index';
	var urlForm = global.baseUrl + 'settings/discounts/form-data/';
	...
	function Format(detail){
		...
		if ( typeof detail.PERCENTAGE != 'boolean' )
			detail.PERCENTAGE = detail.PERCENTAGE == 'Y' ? true : false;
