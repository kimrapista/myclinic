...
app.factory('ProceduresServices',function ($http, $q, $filter, $timeout, $interval, global) {

	var url = global.baseUrl + 'settings/procedures/index';
	var urlForm = global.baseUrl + 'settings/procedures/form-data/';
