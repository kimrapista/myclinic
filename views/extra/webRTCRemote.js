...
app.factory('WebRTCRemote', function( $http, $q, global ){
  ...
  var offerSdpValue = null;
  var answerSdpValue = null;
  ...
  async function getMedia() {
    ...
    try {
      ...
      // after allow the permission using the camera
      // auto call the createPeerConnection
      // createPeerConnection();
      // createoffer()
      // setOffer()
      createPeerConnection().then(function(data){
        if( data ){
          createOffer().then(function(data1){
            if( data1 ){
              console.log(data1);
              setOffer();
  ...
  function gotDescription2(description) {
    ...
    answerSdpValue = description.sdp;
  }
