...
app.controller('SubClinic',function($scope, $http, $timeout, $filter, $rootScope, global){ 


	$rootScope.$emit("Title_Global", { TITLE : 'SUBCLINIC', BACKURL:'' });

	$scope.opt = {
		isLoaded : false,
		isSearch : false,
		searchText : '',
		searchUrl : global.baseUrl + 'settings/subclinic/index',
		newUrl : '#!/settings/subclinic/new',
		editUrl :  '#!/settings/subclinic/'
	}
