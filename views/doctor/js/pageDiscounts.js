...
app.controller('Discounts',function($scope, $http, $timeout, $filter, $rootScope, global){ 


	$rootScope.$emit("Title_Global", { TITLE : 'DISCOUNTS', BACKURL:'' });
	...
	$scope.opt = {
		...
		isSearch : false,
		searchText : '',
		searchUrl : global.baseUrl + 'settings/discounts/index',
		newUrl : '#!/settings/discounts/new',
		editUrl :  '#!/settings/discounts/',
