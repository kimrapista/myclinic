...
app.controller('Prescriptions',function($scope, $http, $timeout, $filter, $rootScope, global){ 


	$rootScope.$emit("Title_Global", { TITLE : 'PRESCRIPTIONS', BACKURL:'' });

	$scope.opt = {
		isLoaded : false,
		isSearch : false,
		searchText : '',
		searchUrl : global.baseUrl + 'settings/prescriptions/index',
		newUrl : '#!/settings/prescriptions/new',
		editUrl :  '#!/settings/prescriptions/',
