...
'use strict';
// doctor
app.controller('PageLaboratory', function($scope, $http, $timeout, $filter, $rootScope, global){ 


	$rootScope.$emit("Title_Global", { TITLE : 'LAB TEMPLATE', BACKURL:'' });

	$scope.opt = {
		isLoaded : false,
		isSearch : false,
		searchText : '',
		searchUrl : global.baseUrl + 'settings/laboratory/index',
		newUrl : '#!/settings/labtemplate/new',
		editUrl :  '#!/settings/labtemplate/',
