<section ng-controller="Instructions" >
				...
				<table>
					...
					<tbody>
						<tr ng-repeat="A in LIST | orderBy: ['NAME']">
							...
							<td>
								<md-icon ng-show="A.ACTIVE == 'Y'" class="material-icons">check</md-icon>
								<md-icon ng-hide="A.ACTIVE == 'Y'" class="material-icons">close</md-icon>
							</td>
							<td class="action">
