				...
				<table>
					...
					<tbody>
						<tr ng-repeat="A in LIST | orderBy: ['NAME']">
							...
							<td ng-bind="A.PRICE|number:2" class="text-right"></td>
							<td class="text-center">
								<md-icon ng-show="A.AUTOADD=='Y'" class="material-icons">check</md-icon>
								<md-icon ng-hide="A.AUTOADD=='Y'" class="material-icons">close</md-icon>
							</td>
							<td class="action">
